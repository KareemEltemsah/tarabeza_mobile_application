...
class _PagesWidgetState extends State<PagesWidget> {
    ...
    userRepo.currentUser?.value?.role == "staff"
        ? setState(() {
            ...
            switch (tabItem) {
              case 0:
                widget.currentPage =
                    ReservationsWidget(parentScaffoldKey: widget.scaffoldKey);
                break;
              case 1:
                widget.currentPage =
              ...
              case 2:
                widget.currentPage =
                    TablesWidget(parentScaffoldKey: widget.scaffoldKey);
                break;
            }
          })
        : setState(() {
  ...
  Widget build(BuildContext context) {
    return userRepo.currentUser?.value?.role == "staff"
        ? WillPopScope(
            ...
            child: Scaffold(
              ...
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: [
                  ...
                  BottomNavigationBarItem(
                    icon: new Icon(Icons.weekend_rounded),
                    label: 'Tables',
                  ),
                ],
              ),
