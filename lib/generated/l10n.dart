...
class S {
  ...
  String get search_for_restaurants {
    return Intl.message(
      'Search for restaurants',
  ...
  String get should_be_more_than_5_letters {
    return Intl.message(
      'Should be more than 5 letters',
      name: 'should_be_more_than_5_letters',
      desc: '',
      args: [],
    );
  }
  ...
  String get should_be_more_than_8_letters {
    return Intl.message(
      'Should be more than 8 letters',
      name: 'should_be_more_than_8_letters',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Recent Restaurants`
  String get recent_restaurants {
    return Intl.message(
      'Recent Restaurants',
      name: 'recent_restaurants',
      desc: '',
      args: [],
    );
  }
  ...
  String get recommended_restaurants {
    return Intl.message(
      'Recommended Restaurants',
