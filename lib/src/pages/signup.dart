              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    FormBuilderRadioGroup(
                      name: null,
                      onSaved: (value) => _con.user.role = value,
                      onChanged: (value) {
                        setState(() {
                          _isStaff = value == "staff";
                        });
                      },
                      validator: (value) =>
                          value == null ? 'you must choose role' : null,
                    ...
                    _isStaff
                        ? TextFormField(
                            keyboardType: TextInputType.text,
                            onSaved: (input) => _con.user.restaurant_id = input,
                            validator: (input) => input.length < 6
                                ? S.of(context).should_be_more_than_5_letters
                                : null,
                            decoration: InputDecoration(
                              labelText: S.of(context).restaurant_code,
                        ...
                        : SizedBox(height: 0),
                    _isStaff ? SizedBox(height: 30) : SizedBox(height: 0),
                    BlockButtonWidget(
                      text: Text(
